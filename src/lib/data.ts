...
export const destinations: Destination[] = [
  {
    id: 'luxembourg',
    name: 'Luxembourg',
    description: 'A small European country with a fairy-tale capital, medieval fortifications, and lush, rural landscapes.',
    image: PlaceHolderImages.find(img => img.id === 'dest-luxembourg')!,
    attractions: ['Luxembourg City Old Town', 'Vianden Castle', 'Mullerthal Region'],
  },
  {
    id: 'italy',
    name: 'Italy',
    description: 'Home to ancient Roman ruins, Renaissance art, delicious cuisine, and stunning coastlines.',
    image: PlaceHolderImages.find(img => img.id === 'dest-italy')!,
    attractions: ['Colosseum', 'Tuscany Hills', 'Amalfi Coast'],
  },
  {
    id: 'romania',
    name: 'Romania',
    description: 'A country of dramatic mountains, medieval towns, and the legend of Dracula in Transylvania.',
    image: PlaceHolderImages.find(img => img.id === 'dest-romania')!,
    attractions: ['Bran Castle', 'Bucharest', 'Transfăgărășan Highway'],
  },
  {
    id: 'uk',
    name: 'United Kingdom',
    description: 'A diverse union of countries with a rich history, iconic landmarks, and vibrant cultural scenes.',
